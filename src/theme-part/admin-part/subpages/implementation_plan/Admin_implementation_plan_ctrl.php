...
class Admin_implementation_plan_ctrl {
    ...
    public function __construct() {
        ...
        $this->webp_convertor = new Convertor_to_webp('implementation_plan');
        $this->update_content();
    }
    ...
    private function update_img_content(string $field_name, string $post_name){
        ...
        $path_curr_file_webp = dirname(__DIR__, 4) . "/asset/img/implementation_plan/" . $current_img_name_webp; 
